cities = [
    ...
    "Сарканд(Алматинская область)",
    "Сарыагаш(Южно-Казахстанская область)",
    "Сатпаев(Карагандинская область)",
    "Семей(Восточно-Казахстанская область)",
    "Сергеевка(Северо-Казахстанская область)",
    ...
    "Тараз(Жамбыльская область)",
    "Текели(Алматинская область)",
    "Темир(Актюбинская область)",
    ...
    "Аккурган(Ташкентская область)",
    "Акташ(Самаркандская область)",
    "Алат(Бухарская область)",
    "Алмалык(Ташкентская область)",
    "Ангрен(Ташкентская область)",
    "Андижан(Андижанская область)",
    "Асака(Андижанская область)",
    "Ахангаран(Ташкентская область)",
    "Байсун(Сурхандарьинская область)",
    "Бахт(Сырдарьинская область)",
    "Бекабад(Ташкентская область)",
    "Беруни(Республика Каракалпакстан)",
    "Бешарык(Ферганская область)",
    "Бешкент(Кашкадарьинская область)",
    "Бука(Ташкентская область)",
    "Булунгур(Самаркандская область)",
    "Бустан(Республика Каракалпакстан)",
    "Бухара(Бухарская область)",
    "Вабкент(Бухарская область)",
    "Гагарин(Джизакская область)",
    "Газалкент(Ташкентская область)",
    "Газли(Бухарская область)",
    "Галаасия(Бухарская область)",
    "Галляарал(Джизакская область)",
    "Гиждуван(Бухарская область)",
    "Гузар(Кашкадарьинская область)",
    "Гулистан(Сырдарьинская область)",
    "Даштабад(Джизакская область)",
    "Денау(Сурхандарьинская область)",
    "Джалакудук(Андижанская область)",
    "Джамбай(Самаркандская область)",
    "Джаркурган(Сурхандарьинская область)",
    "Джизак(Джизакская область)",
    "Джума(Самаркандская область)",
    "Дустабад(Ташкентская область)",
    "Дустлик(Джизакская область)",
    "Зарафшан(Навоийская область)",
    "Иштыхан(Самаркандская область)",
    "Каган(Бухарская область)",
    "Камаши(Кашкадарьинская область)",
    "Каракуль(Бухарская область)",
    "Карасу(Андижанская область)",
    "Караулбазар(Бухарская область)",
    "Карши(Кашкадарьинская область)",
    "Касан(Кашкадарьинская область)",
    "Касансай(Наманганская область)",
    "Каттакурган(Самаркандская область)",
    "Келес(Ташкентская область)",
    "Китаб(Кашкадарьинская область)",
    "Коканд(Ферганская область)",
    "Кува(Ферганская область)",
    "Кувасай(Ферганская область)",
    "Кумкурган(Сурхандарьинская область)",
    "Кунград(Республика Каракалпакстан)",
    "Кургантепа(Андижанская область)",
    "Кызылтепа(Навоийская область)",
    "Мангит(Республика Каракалпакстан)",
    "Маргилан(Ферганская область)",
    "Мархамат(Андижанская область)",
    "Мубарек(Кашкадарьинская область)",
    "Муйнак(Республика Каракалпакстан)",
    "Навои(Навоийская область)",
    "Наманган(Наманганская область)",
    "Нукус(Республика Каракалпакстан)",
    "Нурабад(Самаркандская область)",
    "Нурата(Навоийская область)",
    "Нурафшон(Ташкентская область)",
    "Пайарык(Самаркандская область)",
    "Пайтуг(Андижанская область)",
    "Пап(Наманганская область)",
    "Паркент(Ташкентская область)",
    "Пахтаабад(Андижанская область)",
    "Пахтакор(Джизакская область)",
    "Питнак(Хорезмская область)",
    "Пскент(Ташкентская область)",
    "Риштан(Ферганская область)",
    "Ромитан(Бухарская область)",
    "Самарканд(Самаркандская область)",
    "Сырдарья(Сырдарьинская область)",
    "Талимарджан(Кашкадарьинская область)",
    "Тахиаташ(Республика Каракалпакстан)",
    "Ташкент(Ташкент)",
    "Термез(Сурхандарьинская область)",
    "Тинчлик(Ферганская область)",
    "Туракурган(Наманганская область)",
    "Турткуль(Республика Каракалпакстан)",
    "Ургенч(Хорезмская область)",
    "Ургут(Самаркандская область)",
    "Учкудук(Навоийская область)",
    "Учкурган(Наманганская область)",
    "Фергана(Ферганская область)",
    "Хаккулабад(Наманганская область)",
    "Халкабад(Республика Каракалпакстан)",
    "Ханабад(Андижанская область)",
    "Хива(Хорезмская область)",
    "Ходжаабад(Андижанская область)",
    "Ходжейли(Республика Каракалпакстан)",
    "Чартак(Наманганская область)",
    "Челек(Самаркандская область)",
    "Чимбай(Республика Каракалпакстан)",
    "Чиназ(Ташкентская область)",
    "Чиракчи(Кашкадарьинская область)",
    "Чирчик(Ташкентская область)",
    "Чуст(Наманганская область)",
    "Шаргунь(Сурхандарьинская область)",
    "Шафиркан(Бухарская область)",
    "Шахрисабз(Кашкадарьинская область)",
    "Шахрихан(Андижанская область)",
    "Шерабад(Сурхандарьинская область)",
    "Ширин(Сырдарьинская область)",
    "Шуманай(Республика Каракалпакстан)",
    "Шурчи(Сурхандарьинская область)",
    "Яйпан(Ферганская область)",
    "Яккабаг(Кашкадарьинская область)",
    "Янгиабад(Ташкентская область)",
    "Янгиер(Сырдарьинская область)",
    "Янги-Нишан(Кашкадарьинская область)",
    "Янгирабад(Навоийская область)",
